...
struct CollarClubApp: App {
	...
	@State var currentUser = CurrentUser.shared
	@State var cartManager = CartManager.shared
	...
	@State var isSignedIn = AuthServiceFactory.create().token != nil
