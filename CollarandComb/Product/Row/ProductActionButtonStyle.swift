//
//  ProductActionButtonStyle.swift
//  CollarandComb
//
...
extension ButtonStyle where Self == ProductActionButtonStyle {
  static func statusAction(isOn: Bool = false, tintColor: Color? = nil) -> Self {
	  ProductActionButtonStyle(isOn: isOn, tintColor: tintColor)
  }
}
...
struct ProductActionButtonStyle: ButtonStyle {
  var isOn: Bool
  var tintColor: Color?
