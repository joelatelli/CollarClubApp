  ...
  public struct MainView: View {
	...
	public var body: some View {
	  ...
	  NavigationStack {
		...
		.onDrop(of: ProductEditor.UTTypeSupported.types(), delegate: focusedSEVM)
	  ...
	  .sheet(item: $editingMediaContainer) { container in
		  ProductEditor.MediaEditView(viewModel: focusedSEVM, container: container)
	  }
