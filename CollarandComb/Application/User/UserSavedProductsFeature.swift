//
//  UserSavedProductsFeature.swift
//  CollarandComb
//
...
struct UserSavedProductsFeature {
...
extension UserSavedProductsFeature: ReducerProtocol {
...
//				)
		...
		.forEach(\.productList, action: /UserSavedProductsFeature.Action.productRowAction) {
			ProductRowFeature()
		}
	}
}
