//
//  UserProductHistoryFeature.swift
//  CollarandComb
//
...
struct serProductHistoryFeature: ReducerProtocol {
...
//					state.page += 1
		...
		.forEach(\.productList, action: /serProductHistoryFeature.Action.productRowAction) {
			ProductRowFeature()
		}
	}
}
