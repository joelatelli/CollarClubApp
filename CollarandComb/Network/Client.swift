...
@Observable public final class Client: Equatable, Identifiable, Hashable {
	...
	func makeKaizenURL(scheme: String = "https",
					   endpoint: Endpoint) -> URL
	{
		var components = URLComponents()
		components.scheme = scheme
//		components.host = "caf-vapor-api-c922eaf44828.herokuapp.com"
		components.host = "node-db-collar-club-9d8f9fa7d4eb.herokuapp.com"
...
//		let url = try makeURL(endpoint: endpoint, forceVersion: forceVersion)
		let url = try makeKaizenURL(endpoint: endpoint)
