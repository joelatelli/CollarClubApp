...
@MainActor
@Observable class OrderHistoryListViewModel {
	var userId: String?
	...
	var ordersState: OrdersState = .loading
...
extension OrderHistoryListViewModel: OrdersFetcher {

	func orderDidAppear(order status: Order) {
