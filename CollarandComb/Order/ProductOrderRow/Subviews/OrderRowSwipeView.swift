...
@MainActor
struct OrderRowSwipeView: View {
	@Environment(Theme.self) private var theme
	@Environment(UserPreferences.self) private var preferences
	@Environment(CurrentAccount.self) private var currentAccount
	@Environment(OrderDataController.self) private var statusDataController
...
//		viewModel.product.visibility == .priv
	...
	var viewModel: OrderHistoryRowViewModel
	let mode: Mode
...
@MainActor
struct ProductOrderRowSwipeView: View {
	@Environment(Theme.self) private var theme
	@Environment(UserPreferences.self) private var preferences
	@Environment(CurrentAccount.self) private var currentAccount
	@Environment(OrderDataController.self) private var productDataController
...
//		viewModel.product.visibility == .priv
	...
	var viewModel: ProductOrderRowViewModel
	let mode: Mode
